...
// set up handler for cancel button, then return to deck screen
...
x	The screen displays the React Router: Add Card deck title.
x	A form is shown with the "front" and "back" fields for a new card. 
Both fields use a <textarea> tag that can accommodate multiple lines of text.
x	If the user clicks Save, a new card is created and associated with the relevant deck. Then the form is cleared and the process 
for adding a card is restarted.
x	If the user clicks Done, the user is taken to the Deck screen.
*/